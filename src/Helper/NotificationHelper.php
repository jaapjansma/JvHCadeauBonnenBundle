...
class NotificationHelper {
    ...
    public function sendCodePerEmail(ProductCollectionItem $item, Order $order, Rule $rule) {
        // Load language file
        System::loadLanguageFile('tl_member');
        $delimiter = ",";

        $arrTokens = array();
        $arrTokens['recipient_email'] = $order->getEmailRecipient();
        ...
        $objNotificationCollection = \NotificationCenter\Model\Notification::findByType('jvh_cadeaubon_created');
