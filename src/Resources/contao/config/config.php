...
$GLOBALS['ISO_HOOKS']['copiedCollectionItems'][] = array('JvH\CadeauBonnenBundle\Listener\UseCadaubon', 'copiedCollectionItems');
...
$GLOBALS['NOTIFICATION_CENTER']['NOTIFICATION_TYPE']['jvh_cadeaubon']['jvh_cadeaubon_created']['email_text'] = ['recipient_email', 'code', 'pin', 'discount', 'member_*', 'product_*', 'rule_*', 'order_*', 'form_*', 'shipping_address_*', 'shipping_address', 'document'];
...
$GLOBALS['NOTIFICATION_CENTER']['NOTIFICATION_TYPE']['jvh_cadeaubon']['jvh_cadeaubon_email']['email_text'] = ['recipient_email', 'code', 'pin', 'discount', 'member_*', 'product_*', 'rule_*', 'order_*', 'form_*', 'shipping_address_*', 'shipping_address', 'document'];
